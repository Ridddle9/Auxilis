...
def start_message(message):
	...
	bot.send_message(message.chat.id, text = "Прежде чем начать, подпишитесь, пожалуйста, на канал проекта - t.me/auxilis_project. Так мы отслеживаем интерес к Окси!", reply_markup=check)
